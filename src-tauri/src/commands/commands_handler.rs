...
pub async fn list_commands(
    ...
    _list_commands(body).await.map_err(|e| e.to_string())
}

async fn _list_commands(body: ListCommandsRequest) -> Result<Value, AppError> {
...
pub async fn load_command(
    body: LoadCommandRequest,
) -> Result<Value, String> {
    _load_command(body).await.map_err(|e| e.to_string())
}

async fn _load_command(body: LoadCommandRequest) -> Result<Value, AppError> {
...
pub async fn execute_command(
    ...
    _execute_command(body).await.map_err(|e| e.to_string())
}

async fn _execute_command(body: ExecuteCommandRequest) -> Result<Value, AppError> {
